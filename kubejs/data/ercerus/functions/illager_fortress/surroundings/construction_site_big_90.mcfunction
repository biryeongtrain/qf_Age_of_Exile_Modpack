#creates a big construction site rotated by 90 degrees



#spawns the structure
setblock ~ ~22 ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"Ercerus",rotation:"CLOCKWISE_90",mode:"LOAD",showboundingbox:0b,integrity:1.0f,showair:0b,sizeX:9,sizeY:23,sizeZ:28,posX:16,posY:-22,posZ:0,name:"ercerus:illager_fortress/surroundings/construction_site_big"}
