...
setblock ~1 ~ ~2 minecraft:hopper[facing=south]{Items:[{Slot:0b,id:"minecraft:rotten_flesh",Count:4b}]}
setblock ~1 ~ ~3 minecraft:hopper[facing=north]
setblock ~1 ~ ~4 minecraft:comparator[facing=north]
setblock ~1 ~ ~5 minecraft:command_block[facing=up]{powered:0b,CustomName:'{"text":"IF Dungeon Loader"}',Command:"function ercerus:illager_fortress/illager_dungeon_loop"}